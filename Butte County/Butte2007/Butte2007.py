...
values=np.cumsum(list(np.loadtxt("./Butte2007.txt")))
dama = np.loadtxt('Butte-tem-2007.txt')
...
param0=np.loadtxt('C_Butte_2007_12400.txt')
ref=[16000000  for i in range(0,365)]
# param0=[16000000  for i in range(0,365)]
...
T=[]
std=10000
for i in range(12401,run_num):
    if i % 1== 0:
        filename = f'C_Butte_2007_{i}.txt'
