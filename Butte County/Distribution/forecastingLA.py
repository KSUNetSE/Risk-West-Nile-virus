...
plt.title('Forecast of Temperature for 2023 in Butte Counti, California')
plt.show()
...
plt.xlabel('Day')
plt.ylabel('Humidity')
plt.title('Forecast of Humidity for 2023 Butte County, California')
plt.show()
...
plt.title('Forecast of Precipitation for 2023 in Butte County, California')
plt.show()
