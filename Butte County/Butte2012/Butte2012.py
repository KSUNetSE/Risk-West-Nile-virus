...
values=np.cumsum(list(np.loadtxt("./Butte2012.txt")))
dama = np.loadtxt('Butte-tem-2012.txt')
...
param0=np.loadtxt('C_Butte_2012_7400.txt')
ref=[13000000  for i in range(0,365)]
#param0=[13000000  for i in range(0,365)]
...
T=[]
std=10000
for i in range(7401,run_num):
    if i % 1== 0:
        filename = f'C_Butte_2012_{i}.txt'
