...
values=np.cumsum(list(np.loadtxt("./Butte2016.txt")))
dama = np.loadtxt('Butte-tem-2016.txt')
...
param0=np.loadtxt('C_Butte_2016_19900.txt')
ref=[13500000  for i in range(0,365)]
#param0=[13500000  for i in range(0,365)]
...
for i in range(19901,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2016_{i}.txt'
