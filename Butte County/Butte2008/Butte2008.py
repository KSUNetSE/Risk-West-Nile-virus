...
values=np.cumsum(list(np.loadtxt("./Butte2008.txt")))
dama = np.loadtxt('Butte-tem-2008.txt')
...
param0=np.loadtxt('C_Butte_2008_16900.txt')
ref=[29500000  for i in range(0,365)]
#param0=[29500000  for i in range(0,365)]
...
T=[]
std=10000
for i in range(16901,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2008_{i}.txt'
