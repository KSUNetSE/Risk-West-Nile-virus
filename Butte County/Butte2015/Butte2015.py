...
values=np.cumsum(list(np.loadtxt("./Butte2015.txt")))
dama = np.loadtxt('Butte-tem-2015.txt')
...
param0=np.loadtxt('C_Butte_2015_8800.txt')
ref=[26500000  for i in range(0,365)]
#param0=[26500000  for i in range(0,365)]
...
for i in range(19901,run_num):
    if i % 1== 0:
        filename = f'C_Butte_2015_{i}.txt'
