...
values=np.cumsum(list(np.loadtxt("./Butte2009.txt")))
dama = np.loadtxt('Butte-tem-2009.txt')
...
param0=np.loadtxt('C_Butte_2009_6200.txt')
ref=[23200000  for i in range(0,365)]
#param0=[23200000  for i in range(0,365)]
...
T=[]
std=50000
for i in range(6201,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2009_{i}.txt'
