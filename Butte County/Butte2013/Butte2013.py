...
values=np.cumsum(list(np.loadtxt("./Butte2013.txt")))
dama = np.loadtxt('Butte-tem-2013.txt')
...
param0=np.loadtxt('C_Butte_2013_19900.txt')
ref=[49100000  for i in range(0,365)]
#param0=[49100000  for i in range(0,365)]
...
for i in range(19901,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2013_{i}.txt'
