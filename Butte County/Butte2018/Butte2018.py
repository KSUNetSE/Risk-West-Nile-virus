...
values=np.cumsum(list(np.loadtxt("./Butte2018.txt")))
dama = np.loadtxt('Butte-tem-2018.txt')
...
param0=np.loadtxt('C_Butte_2018_3700.txt')
ref=[29300000  for i in range(0,365)]
#param0=[29300000  for i in range(0,365)]
...
T=[]
std=100000
for i in range(3701,run_num):
    if i % 1== 0:
        filename = f'C_Butte_2018_{i}.txt'
