...
values=np.cumsum(list(np.loadtxt("./Butte2017.txt")))
dama = np.loadtxt('Butte-tem-2017.txt')
...
param0=np.loadtxt('C_Butte_2017_5800.txt')
ref=[40500000  for i in range(0,365)]
#param0=[40500000  for i in range(0,365)]
...
T=[]
std=100000
for i in range(5801,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2017_{i}.txt'
