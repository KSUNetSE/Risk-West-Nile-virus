...
values=np.cumsum(list(np.loadtxt("./Butte2006.txt")))
dama = np.loadtxt('Butte-tem-2006.txt')
...
param0=np.loadtxt('C_Butte_2006_24600.txt')
ref=[44500000  for i in range(0,365)]
#param0=[44500000  for i in range(0,365)]
...
for i in range(24601,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2006_{i}.txt'
