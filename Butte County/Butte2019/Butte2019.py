...
values=np.cumsum(list(np.loadtxt("./Butte2019.txt")))
dama = np.loadtxt('Butte-tem-2019.txt')
...
param0=np.loadtxt('C_Butte_2019_2700.txt')
ref=[11000000  for i in range(0,365)]
#param0=[11000000  for i in range(0,365)]
...
T=[]
std=50000
for i in range(2701,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2019_{i}.txt'
