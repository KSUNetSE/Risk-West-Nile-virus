...
values=np.cumsum(list(np.loadtxt("./Butte2011.txt")))
dama = np.loadtxt('Butte-tem-2011.txt')
...
param0=np.loadtxt('C_Butte_2011_8000.txt')
ref=[10300000  for i in range(0,365)]
#param0=[10300000  for i in range(0,365)]
...
T=[]
std=10000
for i in range(8001,run_num):
    if i % 100== 0:
        filename = f'C_Butte_2011_{i}.txt'
