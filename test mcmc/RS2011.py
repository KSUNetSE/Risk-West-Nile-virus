...
values=np.cumsum(list(np.loadtxt("./RS2011.txt")))
dama = np.loadtxt('RS-tem-2011.txt')
...
param0=np.loadtxt('C_RS_2011_39900.txt')
ref=[1110000000  for i in range(0,365)]
#param0=[1110000000  for i in range(0,365)]
...
for i in range(39901,run_num):
    if i % 100== 0:
        filename = f'C_RS_2011_{i}.txt'
