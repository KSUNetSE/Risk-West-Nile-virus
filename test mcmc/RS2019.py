...
values=np.cumsum(list(np.loadtxt("./RS2019.txt")))
dama = np.loadtxt('RS-tem-2019.txt')
...
param0=np.loadtxt('C_RS_2019_18400.txt')
ref=[620000000  for i in range(0,365)]
#param0=[620000000  for i in range(0,365)]
...
for i in range(18401,run_num):
    if i % 100== 0:
        filename = f'C_RS_2019_{i}.txt'
