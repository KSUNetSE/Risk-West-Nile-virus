...
values=np.cumsum(list(np.loadtxt("./RS2017.txt")))
dama = np.loadtxt('RS-tem-2017.txt')
...
param0=np.loadtxt('C_RS_2017_17600.txt')
ref=[675000000  for i in range(0,365)]
#param0=[675000000  for i in range(0,365)]
...
for i in range(17601,run_num):
    if i % 100== 0:
        filename = f'C_RS_2017_{i}.txt'
