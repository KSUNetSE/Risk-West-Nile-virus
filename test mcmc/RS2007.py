...
values=np.cumsum(list(np.loadtxt("./RS2007.txt")))
dama = np.loadtxt('RS-tem-2007.txt')
...
param0=np.loadtxt('C_RS_2007_30300.txt')
ref=[633000000  for i in range(0,365)]
#param0=[633000000  for i in range(0,365)]
...
for i in range(30301,run_num):
    if i % 100== 0:
        filename = f'C_RS_2007_{i}.txt'
        ...
        axs[0].set_title(f'{i}: {ll_function(exp_data, param0)[1]}',fontsize=25)
        axs[0].legend()
        axs[1].plot(param0)
