...
values=np.cumsum(list(np.loadtxt("./RS2016.txt")))
dama = np.loadtxt('RS-tem-2016.txt')
...
param0=np.loadtxt('C_RS_2016_17900.txt')
ref=[580000000  for i in range(0,365)]
#param0=[580000000  for i in range(0,365)]
