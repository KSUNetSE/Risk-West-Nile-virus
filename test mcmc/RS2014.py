...
values=np.cumsum(list(np.loadtxt("./RS2014.txt")))
dama = np.loadtxt('RS-tem-2014.txt')
...
param0=np.loadtxt('C_RS_2014_15000.txt')
ref=[334000000  for i in range(0,365)]
#param0=[334000000  for i in range(0,365)]
...
for i in range(15001,run_num):
    if i % 100== 0:
        filename = f'C_RS_2014_{i}.txt'
