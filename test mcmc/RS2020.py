...
values=np.cumsum(list(np.loadtxt("./RS2020.txt")))
dama = np.loadtxt('RS-tem-2020.txt')
...
param0=np.loadtxt('C_RS_2020_20200.txt')
ref=[520000000  for i in range(0,365)]
#param0=[520000000  for i in range(0,365)]
...
for i in range(20201,run_num):
    if i % 100== 0:
        filename = f'C_RS_2020_{i}.txt'
