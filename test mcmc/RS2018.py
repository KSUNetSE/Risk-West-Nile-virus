...
values=np.cumsum(list(np.loadtxt("./RS2018.txt")))
dama = np.loadtxt('RS-tem-2018.txt')
...
param0=np.loadtxt('C_RS_2018_4300.txt')
ref=[375000000  for i in range(0,365)]
#param0=[375000000  for i in range(0,365)]
...
for i in range(4301,run_num):
    if i % 100== 0:
        filename = f'C_RS_2018_{i}.txt'
