...
values=np.cumsum(list(np.loadtxt("./RS2012.txt")))
dama = np.loadtxt('RS-tem-2012.txt')
...
param0=np.loadtxt('C_RS_2012_39900.txt')
ref=[340000000  for i in range(0,365)]
#param0=[340000000  for i in range(0,365)]
