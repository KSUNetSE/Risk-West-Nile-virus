...
values=np.cumsum(list(np.loadtxt("./RS2006.txt")))
dama = np.loadtxt('RS-tem-2006.txt')
...
param0=np.loadtxt('C_RS_2006_24600.txt')
ref=[1426000000  for i in range(0,365)]
#param0=[1426000000  for i in range(0,365)]
