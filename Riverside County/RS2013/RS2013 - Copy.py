...
values=np.cumsum(list(np.loadtxt("./RS2013.txt")))
dama = np.loadtxt('RS-tem-2013.txt')
...
param0=np.loadtxt('C_RS_2013_39700.txt')
ref=[770000000  for i in range(0,365)]
#param0=[770000000  for i in range(0,365)]
...
for i in range(39701,run_num):
    if i % 100== 0:
        filename = f'C_RS_2013_{i}.txt'
