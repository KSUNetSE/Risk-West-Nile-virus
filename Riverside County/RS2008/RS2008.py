...
values=np.cumsum(list(np.loadtxt("./RS2008.txt")))
dama = np.loadtxt('RS-tem-2008.txt')
...
param0=np.loadtxt('C_RS_2008_29600.txt')
ref=[1183000000  for i in range(0,365)]
#param0=[1183000000  for i in range(0,365)]
...
for i in range(29601,run_num):
    if i % 100== 0:
        filename = f'C_RS_2008_{i}.txt'
