...
values=np.cumsum(list(np.loadtxt("./Kern2016.txt")))
dama = np.loadtxt('Kern-tem-2016.txt')
...
param0=np.loadtxt('C_Kern_2016_100.txt')
ref=[169000000  for i in range(0,365)]
#param0=[169000000  for i in range(0,365)]
...
for i in range(101,run_num):
    if i % 100== 0:
        filename = f'C_Kern_2016_{i}.txt'
