...
values=np.cumsum(list(np.loadtxt("./Kern2007.txt")))
dama = np.loadtxt('Kern-tem-2007.txt')
...
param0=np.loadtxt('C_Kern_2007_7700.txt')
ref=[248000000  for i in range(0,365)]
#param0=[248000000  for i in range(0,365)]
...
for i in range(7701,run_num):
    if i % 100== 0:
        filename = f'C_Kern_2007_{i}.txt'
