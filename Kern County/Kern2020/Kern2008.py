...
values=np.cumsum(list(np.loadtxt("./Kern2008.txt")))
dama = np.loadtxt('Kern-tem-2008.txt')
...
param0=np.loadtxt('C_Kern_2008_9600.txt')
ref=[139500000  for i in range(0,365)]
#param0=[139500000  for i in range(0,365)]
...
for i in range(9601,run_num):
    if i % 100== 0:
        filename = f'C_Kern_2008_{i}.txt'
