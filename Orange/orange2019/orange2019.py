...
values=np.cumsum(list(np.loadtxt("./orangecases2019.txt")))
dama = np.loadtxt('orange-mintem-2019.txt')
...
param0=np.loadtxt('C2019_20000.txt')
ref=[10800000000  for i in range(0,365)]
#param0=[10800000000  for i in range(0,365)]
