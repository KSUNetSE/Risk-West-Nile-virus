...
cases=list(np.loadtxt("./orangecases2009.txt"))
values=np.cumsum(cases)
...
# Placeholder for the file path and column index
# file_path = r'C:\Users\shosseini\Desktop\California counties\orange\orange2009\2009.csv'


# # Column index you want to read, for example, 0 for the first column
# i = 3  # Adjust 'i' to target the specific column you're interested in

# # Read the ith column of the CSV file
# df = pd.read_csv(file_path, usecols=[i])

# # Convert the column to a list
# dama= df.iloc[:, 0].tolist()
