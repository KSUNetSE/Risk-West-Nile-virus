...
values=np.cumsum(list(np.loadtxt("./orangecases2015.txt")))
dama = np.loadtxt('orange-mintem-2015.txt')
...
param0=np.loadtxt('C2015_10600.txt')
ref=[7750000000  for i in range(0,365)]
#param0=[7750000000  for i in range(0,365)]
