...
values=np.cumsum(list(np.loadtxt("./orangecases2020.txt")))
dama = np.loadtxt('orange-mintem-2020.txt')
...
param0=np.loadtxt('C2020_10000.txt')
ref=[9500000000  for i in range(0,365)]
#param0=[9500000000  for i in range(0,365)]
