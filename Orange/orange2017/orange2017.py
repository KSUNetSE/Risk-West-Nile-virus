...
values=np.cumsum(list(np.loadtxt("./orangecases2017.txt")))
dama = np.loadtxt('orange-mintem-2017.txt')
...
param0=np.loadtxt('C2017_7600.txt')
ref=[10700000000  for i in range(0,365)]
#param0=[10700000000  for i in range(0,365)]
