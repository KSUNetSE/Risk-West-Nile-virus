...
values=np.cumsum(list(np.loadtxt("./orangecases2016.txt")))
dama = np.loadtxt('orange-mintem-2016.txt')
...
param0=np.loadtxt('C2016_8800.txt')
ref=[8390000000  for i in range(0,365)]
#param0=[8390000000  for i in range(0,365)]
