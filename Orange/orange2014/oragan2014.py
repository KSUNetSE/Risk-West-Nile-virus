...
values=np.cumsum(list(np.loadtxt("./orangecases2014.txt")))
dama = np.loadtxt('orange-mintem-2014.txt')
...
param0=np.loadtxt('C2014_159200.txt')
ref=[9700000000  for i in range(0,365)]
#param0=[9700000000  for i in range(0,365)]
