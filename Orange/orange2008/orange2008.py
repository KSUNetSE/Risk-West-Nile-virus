# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 20:12:07 2024
...
param0=np.loadtxt('C2008_77500.txt')
#param0=[12000000000  for i in range(0,365)]
ref=[12000000000 for i in range(0,365)]
...
for i in range(77501,run_num):
    if i % 1 == 0:
        ...
        plt.plot(datagen(ref)[0],'g--',label='initial')
        plt.xlabel('Time')
        plt.ylabel('Values')
