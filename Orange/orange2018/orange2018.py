...
values=np.cumsum(list(np.loadtxt("./orangecases2018.txt")))
dama = np.loadtxt('orange-mintem-2018.txt')
...
param0=np.loadtxt('C2018_46600.txt')
ref=[6600000000  for i in range(0,365)]
#param0=[6600000000  for i in range(0,365)]
