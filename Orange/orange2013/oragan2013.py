...
values=np.cumsum(list(np.loadtxt("./orangecases2013.txt")))
dama = np.loadtxt('orange-mintem-2013.txt')
...
param0=np.loadtxt('C2013_15100.txt')
ref=[9400000000  for i in range(0,365)]
#param0=[9400000000  for i in range(0,365)]
