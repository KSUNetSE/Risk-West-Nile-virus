...
values=np.cumsum(list(np.loadtxt("./orangecases2012.txt")))
dama = np.loadtxt('orange-mintem-2012.txt')
...
param0=np.loadtxt('C2012_9400.txt')
ref=[11100000000  for i in range(0,365)]
#param0=[11100000000  for i in range(0,365)]
