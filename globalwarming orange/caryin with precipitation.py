# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 15:17:38 2024
...
# # Example usage
file_path = 'info.csv'  # Replace with your actual file path
# year = 2020  # Replace with the desired year

# try:
#     temperature_data = get_temperature_for_year(file_path, year)[2]
#     print(f"Temperature data for the year {year}: {temperature_data}")
...
maxpre=[]
for year in years:
    maxpre.append(max(list(np.loadtxt(f"./P{year}.txt"))))
# print(maxpre)
# print(max(maxpre))
...
for Year in  years:
    ...
    np.savetxt(f'C_pre_{Year}.txt', moving_avg_values_column)
