...
values=np.cumsum(list(np.loadtxt("./LA2019.txt")))
dama = np.loadtxt('LA-tem-2019.txt')
...
param0=np.loadtxt('C_LA_2019_6300.txt')
ref=[36500000000  for i in range(0,365)]
#param0=[36500000000  for i in range(0,365)]
