...
values=np.cumsum(list(np.loadtxt("./LA2006.txt")))
dama = np.loadtxt('LA-tem-2006.txt')
...
param0=np.loadtxt('C_LA_2006_4600.txt')
ref=[30300000000  for i in range(0,365)]
#param0=[30300000000  for i in range(0,365)]
...
T=[]
std=10000000
for i in range(4601,run_num):
    if i % 100== 0:
        filename = f'C_LA_2006_{i}.txt'
