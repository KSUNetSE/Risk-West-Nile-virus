...
values=np.cumsum(list(np.loadtxt("./LA2008.txt")))
dama = np.loadtxt('LA-tem-2008.txt')
...
param0=np.loadtxt('C_LA_2008_19200.txt')
ref=[34900000000  for i in range(0,365)]
#param0=[34900000000  for i in range(0,365)]
...
T=[]
std=50000000
for i in range(19201,run_num):
    if i % 100== 0:
        filename = f'C_LA_2008_{i}.txt'
