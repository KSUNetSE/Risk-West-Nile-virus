...
values=np.cumsum(list(np.loadtxt("./LA2009.txt")))
dama = np.loadtxt('LA-tem-2009.txt')
...
param0=np.loadtxt('C_LA_2009_18700.txt')
ref=[28400000000  for i in range(0,365)]
#param0=[28400000000  for i in range(0,365)]
...
T=[]
std=10000000
for i in range(18701,run_num):
    if i % 100== 0:
        filename = f'C_LA_2009_{i}.txt'
