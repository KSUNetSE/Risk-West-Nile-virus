...
values=np.cumsum(list(np.loadtxt("./LA2018.txt")))
dama = np.loadtxt('LA-tem-2018.txt')
...
param0=np.loadtxt('C_LA_2018_6300.txt')
ref=[26000000000  for i in range(0,365)]
#param0=[26000000000  for i in range(0,365)]
