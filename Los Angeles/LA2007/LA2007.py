...
values=np.cumsum(list(np.loadtxt("./LA2007.txt")))
dama = np.loadtxt('LA-tem-2007.txt')
...
param0=np.loadtxt('C_LA_2007_3000.txt')
ref=[33300000000  for i in range(0,365)]
#param0=[33300000000  for i in range(0,365)]
...
T=[]
std=10000000
for i in range(3001,run_num):
    if i % 100== 0:
        filename = f'C_LA_2007_{i}.txt'
